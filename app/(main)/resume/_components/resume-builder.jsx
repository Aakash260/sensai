...
export default function ResumeBuilder({ initialContent }) {
  ...
  const generatePDF = async () => {
    ...
    try {
      // Create a clean HTML structure without MDEditor styles
      const pdfContent = `
        <!DOCTYPE html>
        <html>
          <head>
            ...
            <style>
              ...
              h1 { font-size: 18px; }
              h2 { font-size: 16px; border-bottom: 1px solid #cccccc; padding-bottom: 5px; }
              h3 { font-size: 14px; }
              p { margin: 5px 0; }
      ...
      // Create a temporary iframe to render the clean HTML
  ...
  // Alternative simpler PDF generation using markdown-to-html conversion
        ...
        <html>
          <head>
            ...
            <style>
              ...
              div[align="center"] { text-align: center; margin: 10px 0; }
            </style>
          </head>
    ...
    <div data-color-mode="light" className="space-y-4">
      <div className="flex flex-col md:flex-row justify-between items-center gap-2">
        ...
        <div className="space-x-2">
          ...
          <Button onClick={generatePDFAlternative} disabled={isGenerating}>
            {isGenerating ? (
              <>
